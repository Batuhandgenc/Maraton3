...
public class User {
	...
	public User(String name, String surname, UserDetail role, Date createAt, Date updatedAt) {
		super();
		this.name = name;
	...
	public UserDetail getRole() {
		return role;
	}

	public void setRole(UserDetail role) {
		this.role = role;
	}
